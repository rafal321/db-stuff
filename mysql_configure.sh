...
# general configs
datadir                                 = $DATA_DIR
#RK collation-server                        = $COLLATION
#RK character_set_server                    = $CHARACTERSET
#RK init-connect                            = SET NAMES $CHARACTERSET
...
# innodb vars
innodb_buffer_pool_size                 = $INNODB_MEM           # bytes    1073741824=1G | 2147483648=2G
