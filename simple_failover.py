#!/usr/bin/python3
# Rafal - testing RDS failover times - ver.4
# based on: https://youtu.be/ERMHycDc8ck?si=Toy1Ot29TfEMHiP3
# > pip3 install pymysql --user
# > pip3 install urllib3 --user
# > echo "-eXXX -uXXX -pXXX" > simple_cred.txt
# > chmod 744 simple_failover.py
# > ./simple_failover.py (cat simple_cred.txt)
# Dependencies
import sys
import argparse
import time
